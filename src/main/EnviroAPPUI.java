...
import helper.ContextCoordinatorWorkerPrx;
...
public class EnviroAPPUI {
	...
	public static ContextCoordinatorWorkerPrx ContextCoordinatorWorker;
	...
	private static void iniContextCoordinatorWorker(String[] args) {
		com.zeroc.Ice.ObjectPrx base = communicator.stringToProxy("ContextCoordinatorWorker:default -p 13333");
		ContextCoordinatorWorker = ContextCoordinatorWorkerPrx.checkedCast(base);
	}
