...
public class ContextCoordinator {
	...
	public static class ContextCoordinatorWorkerI implements ContextCoordinatorWorker {
		...
		public void deleteUser(String username, Current current) {
			...
			if (users.size() == 0) {
				...
				System.out.println("Context Coordinator has terminated!");
			}
		}
	...
	private static void setupContextCoordinatorWorker() {
		com.zeroc.Ice.ObjectAdapter adapter = communicator.createObjectAdapterWithEndpoints("ContextCoordinatorWorker",
				"default -p 13333");
		adapter.add(new ContextCoordinatorWorkerI(), com.zeroc.Ice.Util.stringToIdentity("ContextCoordinatorWorker"));
		adapter.activate();
	}
